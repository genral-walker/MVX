...
export const Nav = () => {
  ...
  return (
    <>
      {drawerOpen && (
        <nav className="bg-white h-[100vh] w-[100vw] fixed top-0 left-0 z-[200] py-5 px-7 sm:px-8">
          <div className="flex justify-between">
            <a href="#">
              <HeroIcon className="cursor-pointer w-20 sm:w-[unset]" />
            </a>
            <CancelIcon
              className="h-8 translate-x-[7px]"
          ...
          <ul className="gap-4 text-md flex flex-col mt-14">
            ...
            <li>
              <Button classes={'w-[100%] mx-auto sm:w-[200px] sm:max-[unset]'}>
                Sign up
              </Button>
            </li>
          </ul>
